...
static const char qt_meta_stringdata_InGameUI[] = {
    ...
    "updateScore(int)\0updateTime(envTime)\0"
    "updateTotalTime(envTime)\0"
};
...
void InGameUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->updateTime((*reinterpret_cast< envTime(*)>(_a[1]))); break;
        case 3: _t->updateTotalTime((*reinterpret_cast< envTime(*)>(_a[1]))); break;
        default: ;
        }
    }
}
